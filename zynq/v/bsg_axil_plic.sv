...
module bsg_axil_plic
 ...
 #(parameter m_axil_data_width_p = 32
  ...
  logic [axil_strb_width_lp-1:0]  axil_wmask_lo;
  ...
  logic [top_pkg::AW-1:0] reg_addr;
  logic [top_pkg::DW-1:0] reg_wdata;
  logic [top_pkg::DBW-1:0] reg_be;
  logic [top_pkg::DW-1:0] reg_rdata;
  ...
  if (axil_addr_width_p > top_pkg::TL_AW)
